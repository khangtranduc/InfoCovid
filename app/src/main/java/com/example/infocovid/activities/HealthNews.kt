 ...
 * Use the [HealthNews.newInstance] factory method to
 * create an instance of this fragment.
 */
class HealthNews : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        health_news_recycler.apply {
            setHasFixedSize(true)
            layoutManager = LinearLayoutManager(context)
            adapter = NewsAdapter(MainActivity.health_new!!)
        }
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment HealthNews.
         */
